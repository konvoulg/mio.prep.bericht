...
* name[name].family.extension[namenszusatz].valueString 0..1
...
* name[name].family.extension[nachname].valueString 0..1 MS

* name[name].family.extension[vorsatzwort] ^mustSupport = true
* name[name].family.extension[vorsatzwort].value[x] 1..1 MS
* name[name].family.extension[vorsatzwort].valueString 0..1 MS
